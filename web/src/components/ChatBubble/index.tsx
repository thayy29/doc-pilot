    ...
    <div className={`${baseStyles} ${variantStyles[variant]} ${className}`}>
      {variant === "assistant" ? (
        <article className="prose prose-sm dark:prose-invert max-w-none
          ...
          prose-code:rounded prose-code:bg-brand/10 prose-code:px-1.5 prose-code:py-0.5 prose-code:text-brand prose-code:text-xs prose-code:font-mono prose-code:before:content-none prose-code:after:content-none
